...
export interface SiteProfile extends BaseProfile {
  ...
  readonly c_cFPLogic?: boolean;
  readonly c_cFPCopyRightText?: RTF2;
  readonly c_header?: {
    readonly logo?: Image;
  ...
  readonly c_bannerText?: string;
  readonly c_bannerURL?: string;
  readonly c_placeholderPhoto?: Image;
  readonly c_footerColumns?: FooterColumn[];
  readonly logo?: ComplexImage;
  readonly c_copyrightText?: RTF2;
  readonly c_companyPhoneNumber: CTA;
  readonly c_footerPhoto: ComplexImage;
  readonly c_defaultResultCard: ResultCard;
}

export interface FooterColumn {
  readonly title?: string;
  readonly footerLink?: CTA[];
...
export interface SearchPageProfile extends BaseProfile {
  ...
  readonly c_searchPlaceholderTextName?: string;
}
...
export interface LocationProfile extends BaseProfile {
  ...
  readonly c_title?: string;
  readonly c_fPName?: string;
  readonly c_virtualAgent?: boolean;
  readonly c_cTALocator1?: string;
  readonly c_baseURL?: string;
  readonly c_cTALocator2?: string;
  readonly c_contactURL?: string;
  readonly c_designations?: string[];
  ...
  readonly dm_directoryParents?: Array<{
    slug: string;
    name: string;
    c_breadcrumb: string;
  }>;
...
export type DirectoryProfile<T> = BaseProfile & {
  ...
  readonly slug: string;
  readonly c_breadcrumb?: string;
  readonly c_addressRegionDisplayName?: string;
  readonly c_directoryHeroDescription?: string;
};
