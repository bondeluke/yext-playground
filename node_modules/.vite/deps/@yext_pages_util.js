...
// node_modules/@yext/pages/dist/util/index.js
...
var Runtime = class {
  constructor() {
    ...
    if (import_browser_or_node.isDeno) {
      this.name = "deno";
      this.version = (Deno == null ? void 0 : Deno.version.deno) || "";
...
var isProduction = (...domains) => {
  var _a;
  const runtime = getRuntime();
  if (runtime.name !== "browser") {
    return false;
  }
  const currentHostname = (_a = window == null ? void 0 : window.location) == null ? void 0 : _a.hostname;
  if (domains.length === 0) {
    return currentHostname !== "localhost" && !currentHostname.includes("preview.pagescdn.com");
  }
  return domains.some((domain) => domain == null ? void 0 : domain.includes(currentHostname));
};
export {
  getRuntime,
  isProduction
