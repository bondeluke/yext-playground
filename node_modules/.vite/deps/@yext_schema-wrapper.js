...
// node_modules/@yext/schema-wrapper/dist/index.mjs
var import_dist = __toESM(require_dist(), 1);
var SchemaWrapper = (json) => {
  return `<script type="application/ld+json">
  ${JSON.stringify(json)}
  <\/script>`;
};
var BaseSchema = (data, schemaType) => {
  return {
...
var getHoursByDay = (hours, hoursMap, day) => {
  var _a, _b;
...
var LocalBusiness = (data, schemaType) => {
...
function getTextNodesFromJson(rtfObject, textNodes) {
...
function getRichTextContent(answer) {
  if (answer.json) {
    const textNodes = [];
...
//# sourceMappingURL=@yext_schema-wrapper.js.map
