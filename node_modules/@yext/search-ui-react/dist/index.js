...
function Dropdown(props) {
  ...
  const [screenReaderKey, setScreenReaderKey] = (0, import_react17.useState)(0);
  const [hasTyped, setHasTyped] = (0, import_react17.useState)(false);
  const [childrenWithDropdownItemsTransformed, items] = (0, import_react17.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react17.default.createElement("div", { ref: containerRef, className: isActive ? activeClassName : className, onKeyDown: handleKeyDown }, /* @__PURE__ */ import_react17.default.createElement(DropdownContext.Provider, { value: dropdownContext }, /* @__PURE__ */ import_react17.default.createElement(InputContext.Provider, { value: inputContext }, /* @__PURE__ */ import_react17.default.createElement(FocusContext.Provider, { value: focusContext }, childrenWithDropdownItemsTransformed))), /* @__PURE__ */ import_react17.default.createElement(
    ScreenReader,
    {
...
function useInputContextInstance() {
  ...
  const [lastTypedOrSubmittedValue, setLastTypedOrSubmittedValue] = (0, import_react17.useState)("");
  return {
    value,
    setValue,
    lastTypedOrSubmittedValue,
...
function useFocusContextInstance(items, lastTypedOrSubmittedValue, setValue, screenReaderKey, setScreenReaderKey, alwaysSelectOption) {
  ...
  const [focusedValue, setFocusedValue] = (0, import_react17.useState)(null);
  const [focusedItemData, setFocusedItemData] = (0, import_react17.useState)(void 0);
...
function useDropdownContextInstance(prevValue, value, index, focusedItemData, screenReaderUUID, setHasTyped, onToggle, onSelect) {
  const [isActive, _toggleDropdown] = (0, import_react17.useState)(false);
...
function getTransformedChildrenAndItemData(children) {
  ...
  const childrenWithDropdownItemsTransformed = recursivelyMapChildren(children, (child) => {
    if (!((0, import_react17.isValidElement)(child) && child.type === DropdownItem)) {
      return child;
    }
    ...
    return (0, import_react17.createElement)(DropdownItemWithIndex, __spreadProps(__spreadValues({}, props), { index: items.length - 1 }));
  });
...
function DropdownInput(props) {
  ...
  const [isTyping, setIsTyping] = (0, import_react18.useState)(true);
  const handleChange = (0, import_react18.useCallback)((e) => {
    setIsTyping(true);
    toggleDropdown(true);
...
function SearchButton({ handleClick, className }) {
  return /* @__PURE__ */ import_react21.default.createElement(
    ...
    /* @__PURE__ */ import_react21.default.createElement(MagnifyingGlassIcon, null)
  );
}
...
function renderHighlightedValue(highlightedValueOrString, customCssClasses) {
  ...
  if (!matchedSubstrings || matchedSubstrings.length === 0) {
    return /* @__PURE__ */ import_react22.default.createElement("span", null, value);
  }
  ...
  for (const { offset, length } of substrings) {
    if (offset > curr) {
      highlightedJSX.push(
        /* @__PURE__ */ import_react22.default.createElement("span", { key: curr, className: cssClasses.nonHighlighted }, value.substring(curr, offset))
      );
    }
    highlightedJSX.push(
      /* @__PURE__ */ import_react22.default.createElement("span", { key: offset, className: cssClasses.highlighted }, value.substring(offset, offset + length))
    );
    curr = offset + length;
  }
  if (curr < value.length) {
    highlightedJSX.push(
      /* @__PURE__ */ import_react22.default.createElement("span", { key: curr, className: cssClasses.nonHighlighted }, value.substring(curr))
    );
  }
  return /* @__PURE__ */ import_react22.default.createElement(import_react22.default.Fragment, null, highlightedJSX);
}
...
function renderAutocompleteResult(result, cssClasses = {}, Icon, ariaLabel) {
  return /* @__PURE__ */ import_react23.default.createElement(import_react23.default.Fragment, null, Icon && /* @__PURE__ */ import_react23.default.createElement("div", { className: cssClasses.icon }, /* @__PURE__ */ import_react23.default.createElement(Icon, null)), /* @__PURE__ */ import_react23.default.createElement("div", { "aria-label": ariaLabel || "", className: cssClasses.option }, renderHighlightedValue(result, cssClasses)));
}

// src/hooks/useAnalytics.ts
var import_react24 = require("react");
var AnalyticsContext = (0, import_react24.createContext)(null);
function useAnalytics() {
  return (0, import_react24.useContext)(AnalyticsContext);
}
...
function SearchBar({
  ...
  const clearAutocomplete = (0, import_react25.useCallback)(() => {
    clearAutocompleteData();
    autocompletePromiseRef.current = void 0;
  }, [autocompletePromiseRef, clearAutocompleteData]);
  const executeQuery = (0, import_react25.useCallback)(() => {
    if (!hideRecentSearches) {
  ...
  const handleSubmit = (0, import_react25.useCallback)((value, index, itemData) => {
  ...
  const updateEntityPreviews = (0, import_react25.useCallback)((query2) => {
  ...
  const handleInputFocus = (0, import_react25.useCallback)((value = "") => {
  ...
  const handleInputChange = (0, import_react25.useCallback)((value = "") => {
    searchActions.setQuery(value);
    updateEntityPreviews(value);
    autocompletePromiseRef.current = executeAutocomplete2();
  }, [searchActions, autocompletePromiseRef, executeAutocomplete2, updateEntityPreviews]);
  const handleClickClearButton = (0, import_react25.useCallback)(() => {
  ...
  function renderRecentSearches() {
    ...
    return filteredRecentSearches == null ? void 0 : filteredRecentSearches.map((result, i) => /* @__PURE__ */ import_react25.default.createElement(
      DropdownItem,
      {
  ...
  const itemDataMatrix = (0, import_react25.useMemo)(() => {
    var _a2;
  ...
  function renderQuerySuggestions() {
    return autocompleteResponse == null ? void 0 : autocompleteResponse.results.map((result, i) => {
      var _a2;
      return /* @__PURE__ */ import_react25.default.createElement(import_react25.Fragment, { key: i }, /* @__PURE__ */ import_react25.default.createElement(
        DropdownItem,
        {
      ...
      ), showVerticalLinks && !isVertical && ((_a2 = result.verticalKeys) == null ? void 0 : _a2.map((verticalKey2, j) => /* @__PURE__ */ import_react25.default.createElement(
        DropdownItem,
        {
          key: j,
          className: "flex items-stretch py-1.5 px-3.5 cursor-pointer hover:bg-gray-100",
  ...
  function renderClearButton() {
    ...
    ), /* @__PURE__ */ import_react25.default.createElement(VerticalDividerIcon, { className: cssClasses.verticalDivider }));
  }
  ...
  const handleToggleDropdown = (0, import_react25.useCallback)((isActive) => {
    if (!isActive) {
      clearAutocomplete();
    }
  }, [clearAutocomplete]);
  return /* @__PURE__ */ import_react25.default.createElement("div", { className: cssClasses.searchBarContainer }, /* @__PURE__ */ import_react25.default.createElement(
    Dropdown,
    {
    ...
    /* @__PURE__ */ import_react25.default.createElement("div", { className: "inline-flex items-center justify-between w-full" }, renderInput(), query && renderClearButton(), /* @__PURE__ */ import_react25.default.createElement(
    ...
    hasItems && /* @__PURE__ */ import_react25.default.createElement(StyledDropdownMenu, { cssClasses }, renderRecentSearches(), renderQuerySuggestions(), showEntityPreviewsDivider && /* @__PURE__ */ import_react25.default.createElement("div", { className: cssClasses.entityPreviewsDivider }), entityPreviews)
  ));
}
function StyledDropdownMenu({ cssClasses, children }) {
  return /* @__PURE__ */ import_react25.default.createElement(DropdownMenu, null, /* @__PURE__ */ import_react25.default.createElement("div", { className: cssClasses.inputDivider }), /* @__PURE__ */ import_react25.default.createElement("div", { className: "bg-white py-4" }, children));
}
...
function DropdownSearchButton({ handleSubmit, cssClasses }) {
  ...
  return /* @__PURE__ */ import_react25.default.createElement("div", { className: cssClasses.searchButtonContainer }, /* @__PURE__ */ import_react25.default.createElement(
    SearchButton,
    {
...
function calculateEntityPreviewsCount(children) {
  ...
  recursivelyMapChildren(children, (c) => {
    if ((0, import_react25.isValidElement)(c) && c.type === DropdownItem) {
      count++;
    }
    return c;
  });
...
function isDirectAnswer(data) {
  return (data == null ? void 0 : data.type) === import_search_headless_react8.DirectAnswerType.FeaturedSnippet || (data == null ? void 0 : data.type) === import_search_headless_react8.DirectAnswerType.FieldValue;
}
function useCardAnalytics() {
  ...
  const reportCtaEvent = (0, import_react26.useCallback)((result, eventType) => {
  ...
  const reportFeedbackEvent = (0, import_react26.useCallback)((result, feedbackType) => {
    if (!queryId) {
  ...
  const reportAnalyticsEvent = (0, import_react26.useCallback)((cardResult, analyticsEventType) => {
    if (!analytics) {
      return;
    }
...
function useCardFeedbackCallback(result) {
  const reportAnalyticsEvent = useCardAnalytics();
  return (0, import_react28.useCallback)((analyticsType) => {
    reportAnalyticsEvent(result, analyticsType);
...
function SpellCheck({
  ...
  var _a, _b, _c;
  const verticalKey = (_a = (0, import_search_headless_react9.useSearchState)((state) => state.vertical.verticalKey)) != null ? _a : "";
  const cssClasses = useComposedCssClasses(builtInCssClasses3, customCssClasses);
  const correctedQuery = (_b = (0, import_search_headless_react9.useSearchState)((state) => state.spellCheck.correctedQuery)) != null ? _b : "";
  ...
  const handleClickSuggestion = (0, import_react29.useCallback)(() => {
  ...
  return /* @__PURE__ */ import_react29.default.createElement("div", { className: containerClassNames }, /* @__PURE__ */ import_react29.default.createElement("span", { className: cssClasses.helpText }, "Did you mean "), /* @__PURE__ */ import_react29.default.createElement("button", { className: cssClasses.link, onClick: handleClickSuggestion }, correctedQuery));
}
...
function ThumbsFeedback(props) {
  ...
  const [isFeedbackProvided, setIsFeedbackProvided] = (0, import_react31.useState)(false);
  const handleClickThumbsUp = (0, import_react31.useCallback)(() => {
    onClick("THUMBS_UP");
    setIsFeedbackProvided(true);
  }, [onClick]);
  const handleClickThumbsDown = (0, import_react31.useCallback)(() => {
    onClick("THUMBS_DOWN");
    setIsFeedbackProvided(true);
  }, [onClick]);
  useLayoutEffect2(() => {
  ...
  return /* @__PURE__ */ import_react31.default.createElement("div", { className: cssClasses.thumbsFeedbackContainer }, isFeedbackProvided ? feedbackTextOnSubmission : /* @__PURE__ */ import_react31.default.createElement(import_react31.default.Fragment, null, feedbackText, /* @__PURE__ */ import_react31.default.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ import_react31.default.createElement(ThumbIcon, null)
...
function FieldValueDirectAnswer2({
  ...
  const resultContent = (0, import_react32.useMemo)(() => {
    return getResultContent(result, UnknownFieldTypeDisplay);
  }, [result, UnknownFieldTypeDisplay]);
  return /* @__PURE__ */ import_react32.default.createElement("div", { className: cssClasses.answerContainer }, title && /* @__PURE__ */ import_react32.default.createElement("div", { className: cssClasses.header }, title), /* @__PURE__ */ import_react32.default.createElement("div", { className: cssClasses.content }, /* @__PURE__ */ import_react32.default.createElement("div", { className: cssClasses.body }, resultContent), link && /* @__PURE__ */ import_react32.default.createElement("div", { className: "mt-4" }, /* @__PURE__ */ import_react32.default.createElement("a", { href: link, className: "text-primary", onClick: viewDetailsClickHandler }, "View Details"))));
}
...
function getResultContent(result, UnknownFieldTypeDisplay = DefaultUnknownFieldTypeDisplay) {
  switch (result.fieldType) {
    ...
    case import_search_headless_react11.BuiltInFieldType.Hours:
      return /* @__PURE__ */ import_react32.default.createElement("div", null, JSON.stringify(result.value));
    case "unknown":
      return /* @__PURE__ */ import_react32.default.createElement(UnknownFieldTypeDisplay, { result });
    default:
      return Array.isArray(result.value) ? getListJsxElement(result.value, (val) => getTextJsxElement(val)) : getTextJsxElement(result.value);
  }
}
function getListJsxElement(list, getItemJsxElement) {
  return /* @__PURE__ */ import_react32.default.createElement("ul", { className: "list-disc list-inside" }, list.map((el, i) => /* @__PURE__ */ import_react32.default.createElement("li", { key: i }, getItemJsxElement(el))));
}
function getTextJsxElement(text) {
  return /* @__PURE__ */ import_react32.default.createElement("p", { className: "whitespace-pre-wrap" }, text);
}
function getAnchorTagJsxElement(href, displayText) {
  return /* @__PURE__ */ import_react32.default.createElement("a", { href, className: "text-primary" }, displayText != null ? displayText : href);
}
function getAddressJsxElement(address) {
  if (address.extraDescription) {
    return /* @__PURE__ */ import_react32.default.createElement("div", null, address.extraDescription);
  }
  ...
  return /* @__PURE__ */ import_react32.default.createElement("div", null, address.line1 && /* @__PURE__ */ import_react32.default.createElement("p", null, address.line1), address.line2 && /* @__PURE__ */ import_react32.default.createElement("p", null, address.line2), address.line3 && /* @__PURE__ */ import_react32.default.createElement("p", null, address.line3), formattedCityRegionPostalCode && /* @__PURE__ */ import_react32.default.createElement("p", null, formattedCityRegionPostalCode), /* @__PURE__ */ import_react32.default.createElement("p", null, address.countryCode));
}
...
function FeaturedSnippetDirectAnswer({
  ...
  let snippet;
  const snippetValue = (0, import_react33.useMemo)(() => {
    var _a2;
    return { __html: (_a2 = result.snippet) == null ? void 0 : _a2.value };
  }, [(_a = result.snippet) == null ? void 0 : _a.value]);
  if (result.fieldType === "html") {
    snippet = /* @__PURE__ */ import_react33.default.createElement("div", { dangerouslySetInnerHTML: snippetValue });
  } else {
  ...
  return /* @__PURE__ */ import_react33.default.createElement("div", { className: cssClasses.answerContainer }, answer && /* @__PURE__ */ import_react33.default.createElement("div", { className: cssClasses.header }, answer), /* @__PURE__ */ import_react33.default.createElement("div", { className: cssClasses.content }, /* @__PURE__ */ import_react33.default.createElement("div", { className: cssClasses.body }, snippet), link && name && /* @__PURE__ */ import_react33.default.createElement("div", { className: "pt-4 text-neutral" }, snippetLinkMessage, /* @__PURE__ */ import_react33.default.createElement(
    "a",
    {
...
function DirectAnswer({
  ...
  return /* @__PURE__ */ import_react34.default.createElement("div", { className: containerCssClasses }, directAnswerResult.type === import_search_headless_react12.DirectAnswerType.FieldValue ? /* @__PURE__ */ import_react34.default.createElement(
...
function FilterSearch({
  ...
  const matchingFieldIds = (0, import_react35.useMemo)(() => {
  ...
  const [currentFilter, setCurrentFilter] = (0, import_react35.useState)();
  const [filterQuery, setFilterQuery] = (0, import_react35.useState)();
  const staticFilters = (0, import_search_headless_react13.useSearchState)((state) => state.filters.static);
  const matchingFilters = (0, import_react35.useMemo)(() => {
    var _a;
  ...
  const sections = (0, import_react35.useMemo)(() => {
    var _a;
  ...
  const handleSelectDropdown = (0, import_react35.useCallback)((_value, _index, itemData) => {
  ...
  const meetsSubmitCritera = (0, import_react35.useCallback)((index) => index >= 0, []);
  ...
  function renderDropdownItems() {
    return sections.map((section, sectionIndex) => {
      return /* @__PURE__ */ import_react35.default.createElement("div", { className: "pb-2", key: sectionIndex }, section.label && /* @__PURE__ */ import_react35.default.createElement("div", { className: cssClasses.sectionLabel }, section.label), /* @__PURE__ */ import_react35.default.createElement("div", { className: cssClasses.optionsContainer }, section.results.map((result, index) => /* @__PURE__ */ import_react35.default.createElement(
        DropdownItem,
        {
          key: index,
  ...
  return /* @__PURE__ */ import_react35.default.createElement("div", { className: cssClasses.filterSearchContainer }, label && /* @__PURE__ */ import_react35.default.createElement("h1", { className: cssClasses.label }, label), /* @__PURE__ */ import_react35.default.createElement(
    Dropdown,
    {
    ...
    /* @__PURE__ */ import_react35.default.createElement(DropdownMenu, null, hasResults && /* @__PURE__ */ import_react35.default.createElement("div", { className: "absolute z-10 w-full shadow-lg rounded-md border border-gray-300 bg-white pt-3 pb-1 mt-1" }, renderDropdownItems()))
  ));
}
...
function LocationBias({
  ...
  const [isFetchingLocation, setIsFetchingLocation] = (0, import_react37.useState)(false);
  ...
  return /* @__PURE__ */ import_react37.default.createElement("div", { className: cssClasses.locationBiasContainer }, /* @__PURE__ */ import_react37.default.createElement("span", { className: cssClasses.location }, locationBias.displayName), /* @__PURE__ */ import_react37.default.createElement("span", { className: cssClasses.source }, attributionMessage, /* @__PURE__ */ import_react37.default.createElement("span", { className: "invisible lg:visible" }, " - ")), /* @__PURE__ */ import_react37.default.createElement("div", { className: "flex flex-row items-center" }, /* @__PURE__ */ import_react37.default.createElement(
    "button",
    {
...
function useGeolocationHandler({
  ...
  const [isFetchingUserLocation, setIsFetchingUserLocation] = (0, import_react39.useState)(false);
  ...
  const defaultHandleUserPosition = (0, import_react39.useCallback)((position) => {
  ...
  const geolocationHandler = (0, import_react39.useCallback)(async () => {
...
function Geolocation({
  ...
  return /* @__PURE__ */ import_react40.default.createElement("div", { className: cssClasses.geolocationContainer }, /* @__PURE__ */ import_react40.default.createElement("button", { className: cssClasses.button, onClick: handleGeolocationClick }, label), /* @__PURE__ */ import_react40.default.createElement("div", { className: cssClasses.iconContainer }, isFetchingUserLocation ? /* @__PURE__ */ import_react40.default.createElement(LoadingIndicator, null) : /* @__PURE__ */ import_react40.default.createElement(GeolocationIcon, null)));
}
...
function AppliedFiltersDisplay(props) {
  ...
  return /* @__PURE__ */ import_react42.default.createElement("div", { className: cssClasses.appliedFiltersContainer, "aria-label": "Applied filters to current search" }, dedupedNlpFilterDisplayNames.map((displayName, i) => renderNlpFilter(displayName, i, cssClasses)), dedupedRemovableFilters.map((f, i) => {
    return renderRemovableFilter(f.displayName, () => handleRemoveDedupedFilter(f), i, cssClasses);
  }), removableFilters.length > 0 && /* @__PURE__ */ import_react42.default.createElement("button", { onClick: handleClickClearAllButton, className: cssClasses.clearAllButton }, "Clear All"));
}
...
function renderRemovableFilter(displayName, handleRemove, index, cssClasses) {
  return /* @__PURE__ */ import_react42.default.createElement("div", { className: cssClasses.removableFilter, key: `${displayName}-${index}` }, /* @__PURE__ */ import_react42.default.createElement("div", { className: cssClasses.filterLabel }, displayName), /* @__PURE__ */ import_react42.default.createElement(
    "button",
    {
...
function renderNlpFilter(displayName, index, cssClasses) {
  return /* @__PURE__ */ import_react42.default.createElement("div", { className: cssClasses.nlpFilter, key: `${displayName}-${index}` }, /* @__PURE__ */ import_react42.default.createElement("span", { className: cssClasses.filterLabel }, displayName));
}
...
var FiltersContext = (0, import_react44.createContext)(null);
function useFiltersContext() {
  const filtersContextInstance = (0, import_react44.useContext)(FiltersContext);
...
function HierarchicalFacetDisplay({
  ...
  const [isShowingMore, setIsShowingMore] = (0, import_react45.useState)(false);
  const resetShowMore = (0, import_react45.useCallback)(() => setIsShowingMore(false), []);
  const toggleShowMore = (0, import_react45.useCallback)(() => {
  ...
  function renderAvailableOptions(nodes) {
    ...
    return nodesToRender.map(
      (n) => /* @__PURE__ */ import_react45.default.createElement(
        AvailableOption,
        {
  ...
  function renderCategory(selectedNode, fieldId) {
    ...
    if (selectedNode.hasSelectedChild) {
      return /* @__PURE__ */ import_react45.default.createElement(ParentCategory, __spreadValues({ className: cssClasses.parentCategory }, sharedProps));
    } else {
      return /* @__PURE__ */ import_react45.default.createElement(CurrentCategory, __spreadValues({ className: cssClasses.currentCategory }, sharedProps));
    }
  }
  return /* @__PURE__ */ import_react45.default.createElement("div", { className: cssClasses.treeContainer }, renderTree());
}
function AllCategories({ facet, inactiveClassName, activeClassName, resetShowMore }) {
  ...
  const handleClickAllCategories = (0, import_react45.useCallback)(() => {
  ...
  return /* @__PURE__ */ import_react45.default.createElement("div", { className: activeClassName }, "All Categories");
}
function AvailableOption(props) {
  ...
  const handleClickAvailableOptions = (0, import_react45.useCallback)(() => {
    var _a2;
...
function ParentCategory({ fieldId, selectedNode, className, resetShowMore }) {
  const { applyFilters, selectFilter } = useFiltersContext();
  const deselectChildOptions = (0, import_react45.useCallback)((node) => {
  ...
  const handleClickParentCategory = (0, import_react45.useCallback)(() => {
  ...
  return /* @__PURE__ */ import_react45.default.createElement("button", { className, onClick: handleClickParentCategory }, selectedNode.lastDisplayNameToken + " /");
}
function CurrentCategory({ fieldId, selectedNode, className, resetShowMore }) {
  var _a;
  const { applyFilters, selectFilter } = useFiltersContext();
  const handleClickCurrentCategory = (0, import_react45.useCallback)(() => {
    var _a2;
    selectFilter(__spreadProps(__spreadValues({}, selectedNode.facetOption), {
      selected: false,
      fieldId
...
function ShowMoreButton({ className, isShowingMore, toggleShowMore }) {
  return /* @__PURE__ */ import_react45.default.createElement("button", { className, onClick: toggleShowMore }, isShowingMore ? "Show less" : "Show more");
}
...
function useStateUpdatedOnSearch(stateSelector) {
  ...
  const wasLoading = (0, import_react47.useRef)(isLoading);
  const currentState = (0, import_search_headless_react19.useSearchState)(stateSelector);
  const snapshottedState = (0, import_react47.useRef)(currentState);
...
function VerticalResultsDisplay(props) {
  ...
  return /* @__PURE__ */ import_react51.default.createElement("div", { className: resultsClassNames }, results == null ? void 0 : results.map((result) => renderResult(CardComponent, result)));
}
function renderResult(CardComponent, result) {
  return /* @__PURE__ */ import_react51.default.createElement(CardComponent, { result, key: result.id || result.index });
}
...
function StandardCardDisplay(props) {
  ...
  function renderTitle(title2, link2) {
    ...
    return link2 ? /* @__PURE__ */ import_react52.default.createElement("a", { href: link2, className: "text-lg font-medium text-primary hover:underline focus:underline", onClick: clickHandlers.handleTitleClick }, titleJsx) : /* @__PURE__ */ import_react52.default.createElement("div", { className: cssClasses.title }, titleJsx);
  }
  function renderCTAs(cta12, cta22) {
    if (cta12 || cta22) {
      return /* @__PURE__ */ import_react52.default.createElement("div", { className: "flex flex-col justify-end ml-4" }, cta12 && /* @__PURE__ */ import_react52.default.createElement("button", { className: cssClasses.cta1, onClick: clickHandlers.handleCtaClick }, cta12.label), cta22 && /* @__PURE__ */ import_react52.default.createElement("button", { className: cssClasses.cta2, onClick: clickHandlers.handleCtaClick }, cta22.label));
    }
    return null;
  }
  function renderDescription(text) {
    if (text) {
      return /* @__PURE__ */ import_react52.default.createElement("div", { className: "w-full" }, renderHighlightedValue(text, { highlighted: "font-semibold", nonHighlighted: "font-normal" }));
    }
    return null;
  }
  ...
  return /* @__PURE__ */ import_react52.default.createElement("div", { className: cssClasses.container }, /* @__PURE__ */ import_react52.default.createElement("div", { className: cssClasses.header }, renderTitle(title, link)), ((_a = description != null ? description : cta1) != null ? _a : cta2) && /* @__PURE__ */ import_react52.default.createElement("div", { className: cssClasses.body }, renderDescription(description), renderCTAs(cta1, cta2)), renderFeedbackIcons());
}
...
function StandardSection(props) {
  ...
  return /* @__PURE__ */ import_react54.default.createElement("section", { className: cssClasses.section }, header, /* @__PURE__ */ import_react54.default.createElement(
...
function SectionHeader(props) {
  ...
  const handleClickViewAllButton = (0, import_react56.useCallback)(() => {
    if (!analytics) {
      return;
    }
    if (!queryId) {
  ...
  return /* @__PURE__ */ import_react56.default.createElement("div", { className: cssClasses.sectionHeaderContainer }, /* @__PURE__ */ import_react56.default.createElement("div", { className: cssClasses.sectionHeaderIconContainer }, /* @__PURE__ */ import_react56.default.createElement(CollectionIcon, null)), /* @__PURE__ */ import_react56.default.createElement("h2", { className: cssClasses.sectionHeaderLabel }, label), appliedQueryFilters && /* @__PURE__ */ import_react56.default.createElement(AppliedFiltersDisplay, { nlpFilterDisplayNames, cssClasses }), viewAllButton && /* @__PURE__ */ import_react56.default.createElement("div", { className: cssClasses.viewMoreContainer }, /* @__PURE__ */ import_react56.default.createElement("a", { className: cssClasses.viewMoreLink, href }, /* @__PURE__ */ import_react56.default.createElement("button", { onClick: handleClickViewAllButton }, "View all"))));
}
...
function UniversalResults({
  ...
  return /* @__PURE__ */ import_react57.default.createElement("div", { className: resultsClassNames }, renderVerticalSections({ resultsFromAllVerticals, showAppliedFilters, verticalConfigMap, cssClasses }));
}
function renderVerticalSections(props) {
  const { resultsFromAllVerticals, verticalConfigMap, cssClasses } = props;
  return /* @__PURE__ */ import_react57.default.createElement(import_react57.default.Fragment, null, resultsFromAllVerticals.filter((verticalResults) => verticalResults.results).map((verticalResults) => {
    var _a;
    ...
    return /* @__PURE__ */ import_react57.default.createElement(
      SectionComponent,
      {
        results,
        verticalKey,
        header: /* @__PURE__ */ import_react57.default.createElement(SectionHeader, __spreadValues({}, {
          label,
          appliedQueryFilters,
          verticalKey,
...
function VerticalResults(props) {
  ...
  return /* @__PURE__ */ import_react58.default.createElement(VerticalResultsDisplay, __spreadValues({ results, isLoading }, otherProps));
}
...
function ChevronIcon({ className }) {
  return /* @__PURE__ */ import_react59.default.createElement(
    ...
    /* @__PURE__ */ import_react59.default.createElement("path", { d: "M1.33341 6.5L6.00008 1.83333L10.6667 6.5", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })
  );
}
...
function Pagination(props) {
  ...
  const navigateToPage = (0, import_react60.useCallback)((newPageNumber) => {
  ...
  return /* @__PURE__ */ import_react60.default.createElement("div", { className: paginationContainerClassNames }, /* @__PURE__ */ import_react60.default.createElement("nav", { className: "inline-flex shadow-sm -space-x-px", "aria-label": "Pagination" }, /* @__PURE__ */ import_react60.default.createElement(
    PaginationButton,
    {
    ...
    /* @__PURE__ */ import_react60.default.createElement(ChevronIcon, { className: cssClasses.icon + " transform -rotate-90" })
...
function StarIcon({ className }) {
  return /* @__PURE__ */ import_react61.default.createElement(
    ...
    /* @__PURE__ */ import_react61.default.createElement("path", { d: "M8.991 0C4.023 0 0 4.032 0 9s4.023 9 8.991 9C13.968 18 18 13.968 18 9s-4.032-9-9.009-9zm3.816 14.4L9 12.105 5.193 14.4l1.008-4.329-3.357-2.907 4.428-.378L9 2.7l1.728 4.077 4.428.378-3.357 2.907z" })
  );
}
...
function AlternativeVerticals({
  ...
  return /* @__PURE__ */ import_react62.default.createElement("div", { className: containerClassNames }, renderNoResultsInfo(), verticalSuggestions && /* @__PURE__ */ import_react62.default.createElement("div", { className: "pt-4 text-neutral-dark" }, /* @__PURE__ */ import_react62.default.createElement("div", { className: cssClasses.categoriesText }, /* @__PURE__ */ import_react62.default.createElement("span", null, processTranslation({
  ...
  })), /* @__PURE__ */ import_react62.default.createElement("strong", null, query)), /* @__PURE__ */ import_react62.default.createElement("ul", { className: "pt-4" }, verticalSuggestions.map(renderSuggestion))));
  function renderNoResultsInfo() {
    return /* @__PURE__ */ import_react62.default.createElement("div", { className: cssClasses.noResultsText }, /* @__PURE__ */ import_react62.default.createElement("span", null, "No results found in ", currentVerticalLabel, "."), isShowingAllResults && /* @__PURE__ */ import_react62.default.createElement("span", null, " Showing all ", currentVerticalLabel, " instead."));
  }
  function renderSuggestion(suggestion) {
    ...
    return /* @__PURE__ */ import_react62.default.createElement("li", { key: suggestion.verticalKey, className: cssClasses.suggestion }, /* @__PURE__ */ import_react62.default.createElement("div", { className: cssClasses.verticalIcon }, /* @__PURE__ */ import_react62.default.createElement(StarIcon, null)), /* @__PURE__ */ import_react62.default.createElement("span", { className: "font-bold" }, suggestion.label, " - ", resultsCountText));
  }
}
...
function ResultsCount({ customCssClasses }) {
  ...
  return /* @__PURE__ */ import_react63.default.createElement("div", { className: resultsCountClassnames }, resultsCountText);
}
...
var FilterGroupContext = (0, import_react64.createContext)(null);
function useFilterGroupContext() {
  const filterGroupContextInstance = (0, import_react64.useContext)(FilterGroupContext);
...
function CheckboxOption(props) {
  ...
  const handleClick = (0, import_react65.useCallback)((checked) => {
    selectFilter({
      matcher,
      fieldId,
      value,
  ...
  const handleChange = (0, import_react65.useCallback)((evt) => {
    handleClick(evt.target.checked);
  }, [handleClick]);
  const optionFilter = (0, import_react65.useMemo)(() => {
    return {
      fieldId,
      matcher,
      value
  ...
  return /* @__PURE__ */ import_react65.default.createElement("div", { className: cssClasses.container }, /* @__PURE__ */ import_react65.default.createElement("div", { className: cssClasses.optionContainer }, /* @__PURE__ */ import_react65.default.createElement(
    "input",
    {
      type: "checkbox",
      id: optionId,
  ...
  ), /* @__PURE__ */ import_react65.default.createElement("label", { className: labelClasses, htmlFor: optionId }, labelText)), isOptionsDisabled && /* @__PURE__ */ import_react65.default.createElement("div", { className: cssClasses.tooltipContainer }, /* @__PURE__ */ import_react65.default.createElement("div", { className: cssClasses.tooltip }, "Clear the range to select options.")));
}
...
function CollapsibleLabel({ label, customCssClasses }) {
  ...
  return /* @__PURE__ */ import_react66.default.createElement("button", __spreadValues({ className: "w-full flex justify-between items-center mb-4" }, getToggleProps()), /* @__PURE__ */ import_react66.default.createElement("div", { className: cssClasses.label }, label), /* @__PURE__ */ import_react66.default.createElement(ChevronIcon, { className: iconClassName }));
}
...
function CollapsibleSection(props) {
  ...
  return /* @__PURE__ */ import_react67.default.createElement("div", __spreadValues({ className }, getCollapseProps()), children);
}
...
function FacetsProvider({
  ...
  const facets = (0, import_react68.useMemo)(() => facetsInState != null ? facetsInState : [], [facetsInState]);
  const filters = (0, import_react68.useMemo)(() => {
  ...
  const filtersContextInstance = (0, import_react68.useMemo)(() => {
    return {
      selectFilter(filter) {
  ...
  return /* @__PURE__ */ import_react68.default.createElement("div", { className }, /* @__PURE__ */ import_react68.default.createElement(FiltersContext.Provider, { value: filtersContextInstance }, children == null ? void 0 : children(facets)));
}
...
function FilterGroupProvider(props) {
  ...
  const [isOptionsDisabled, setIsOptionsDisabled] = (0, import_react69.useState)(false);
  const { getCollapseProps, getToggleProps, isExpanded } = (0, import_react_collapsed.default)({ defaultExpanded });
  const FilterGroupContextInstance = (0, import_react69.useMemo)(() => {
    return {
      fieldId,
      searchValue,
      setSearchValue,
  ...
  return /* @__PURE__ */ import_react69.default.createElement(FilterGroupContext.Provider, { value: FilterGroupContextInstance }, children);
}
...
function SearchInput(props) {
  ...
  const handleChange = (0, import_react70.useCallback)((e) => {
...
function StaticFiltersProvider({
  ...
  const filtersContextInstance = (0, import_react71.useMemo)(() => {
    return {
      selectFilter(filter) {
  ...
  return /* @__PURE__ */ import_react71.default.createElement("div", { className }, /* @__PURE__ */ import_react71.default.createElement(FiltersContext.Provider, { value: filtersContextInstance }, children));
}
...
function InvalidIcon() {
  return /* @__PURE__ */ import_react72.default.createElement("svg", { width: "20", height: "18", viewBox: "0 0 20 18", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, /* @__PURE__ */ import_react72.default.createElement("path", { d: "M9.99955 7V9M9.99955 13H10.0095M3.07134 17H16.9277C18.4673 17 19.4296 15.3333 18.6598 14L11.7316 2C10.9618 0.666667 9.0373 0.666667 8.2675 2L1.33929 14C0.569492 15.3333 1.53174 17 3.07134 17Z", stroke: "#B91C1C", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }));
}
...
function RangeInput(props) {
  ...
  const [minRangeInput, setMinRangeInput] = (0, import_react73.useState)("");
  const [maxRangeInput, setMaxRangeInput] = (0, import_react73.useState)("");
  const staticFilters = (0, import_search_headless_react33.useSearchState)((state) => state.filters.static);
  const fieldValueFilters = (0, import_react73.useMemo)(
  ...
  const rangeFilter = (0, import_react73.useMemo)(() => {
    return {
      kind: "fieldValue",
      fieldId,
  ...
  const handleClickClear = (0, import_react73.useCallback)(() => {
    const displayName = getFilterDisplayName(rangeFilter.value);
    searchActions.setFilterOption({
      filter: rangeFilter,
      selected: false,
  ...
  function renderInput(value, onChange, placeholder) {
    return /* @__PURE__ */ import_react73.default.createElement("div", { className: cssClasses.inputContainer }, inputPrefix && /* @__PURE__ */ import_react73.default.createElement("span", { className: inputPrefixClasses, "aria-hidden": "true" }, inputPrefix), /* @__PURE__ */ import_react73.default.createElement(
      "input",
      {
        type: "text",
        inputMode: "decimal",
  ...
  return /* @__PURE__ */ import_react73.default.createElement("div", { className: cssClasses.rangeInputContainer }, /* @__PURE__ */ import_react73.default.createElement("div", { className: cssClasses.inputRowContainer }, renderInput(minRangeInput, handleMinChange, "Min"), /* @__PURE__ */ import_react73.default.createElement("div", { className: "w-2.5 text-sm text-neutral" }, "-"), renderInput(maxRangeInput, handleMaxChange, "Max"), isDisabled && /* @__PURE__ */ import_react73.default.createElement("div", { className: cssClasses.tooltipContainer }, /* @__PURE__ */ import_react73.default.createElement("div", { className: cssClasses.tooltip }, "Unselect an option to enter in a range."))), !isValid && /* @__PURE__ */ import_react73.default.createElement("div", { className: cssClasses.invalidRowContainer }, /* @__PURE__ */ import_react73.default.createElement(InvalidIcon, null), /* @__PURE__ */ import_react73.default.createElement("div", { className: cssClasses.invalidMessage }, "Invalid range")), hasUserInput && /* @__PURE__ */ import_react73.default.createElement("div", { className: cssClasses.buttonsContainer }, /* @__PURE__ */ import_react73.default.createElement(
    "button",
    {
      className: cssClasses.clearButton,
    ...
    "Clear min and max"
  ), shouldRenderApplyButton && /* @__PURE__ */ import_react73.default.createElement(
    "button",
    {
...
function FacetTitle({
  ...
  const collapsibleLabelCssClasses = (0, import_react74.useMemo)(() => {
    return {
      label: customCssClasses == null ? void 0 : customCssClasses.titleLabel
    };
  }, [customCssClasses]);
  return /* @__PURE__ */ import_react74.default.createElement(import_react74.Fragment, null, collapsible ? /* @__PURE__ */ import_react74.default.createElement(CollapsibleLabel, { label, customCssClasses: collapsibleLabelCssClasses }) : label && /* @__PURE__ */ import_react74.default.createElement("div", { className: twMerge(
    "mb-4",
...
function FilterGroup({
  ...
  const cssClasses = (0, import_react75.useMemo)(() => {
  ...
  return /* @__PURE__ */ import_react75.default.createElement(
    ...
    /* @__PURE__ */ import_react75.default.createElement(CollapsibleSection, { className: cssClasses.optionsContainer }, searchable && /* @__PURE__ */ import_react75.default.createElement(SearchInput, { className: cssClasses.searchInput }), /* @__PURE__ */ import_react75.default.createElement(
      CheckboxOptions,
      {
        filterOptions,
        showMoreLimit,
...
function CheckboxOptions({
  ...
  const [showAll, setShowAll] = (0, import_react75.useState)(!isLimited);
  displayedOptions = displayedOptions.slice(0, showAll ? displayedOptions.length : showMoreLimit);
  return /* @__PURE__ */ import_react75.default.createElement(import_react75.default.Fragment, null, displayedOptions, isLimited && /* eslint-disable-next-line react-perf/jsx-no-new-function-as-prop */
  /* @__PURE__ */ import_react75.default.createElement("button", { className: "text-primary py-1 text-sm", onClick: () => setShowAll(!showAll) }, showAll ? "Show Less" : "Show More"));
}
...
function StaticFilters(props) {
  ...
  return /* @__PURE__ */ import_react76.default.createElement(StaticFiltersProvider, { searchOnChange, className: containerClassName }, /* @__PURE__ */ import_react76.default.createElement(
    FilterGroup,
    __spreadValues({
...
function FilterDivider({ className }) {
  return /* @__PURE__ */ import_react77.default.createElement("div", { className: twMerge("w-full h-px bg-gray-200 my-4", className) });
}
...
function StandardFacets(props) {
  ...
  return /* @__PURE__ */ import_react78.default.createElement(FacetsProvider, { searchOnChange, className: customCssClasses.standardFacetsContainer }, (facets) => facets.filter((f) => !excludedFieldIds.includes(f.fieldId) && isStringFacet(f)).map((f, i) => {
    return /* @__PURE__ */ import_react78.default.createElement(import_react78.Fragment, { key: f.fieldId }, /* @__PURE__ */ import_react78.default.createElement(
      FilterGroup,
      __spreadValues({
        fieldId: f.fieldId,
    ...
    ), i < facets.length - 1 && /* @__PURE__ */ import_react78.default.createElement(FilterDivider, { className: customCssClasses.divider }));
  }));
}
...
function HierarchicalFacets({
  ...
  return /* @__PURE__ */ import_react79.default.createElement(FacetsProvider, { searchOnChange, className: customCssClasses.hierarchicalFacetsContainer }, (facets) => facets.filter((f) => f.options.length > 0 && includedFieldIds.includes(f.fieldId)).map((f, i) => {
    return /* @__PURE__ */ import_react79.default.createElement(import_react79.Fragment, { key: f.fieldId }, /* @__PURE__ */ import_react79.default.createElement(
      FilterGroupProvider,
      {
        fieldId: f.fieldId,
        defaultExpanded: !collapsible || defaultExpanded
      },
      collapsible ? /* @__PURE__ */ import_react79.default.createElement(CollapsibleLabel, { label: f.displayName }) : f.displayName && /* @__PURE__ */ import_react79.default.createElement("div", { className: "text-neutral-dark text-sm font-medium text-left mb-4" }, f.displayName),
      /* @__PURE__ */ import_react79.default.createElement(CollapsibleSection, null, /* @__PURE__ */ import_react79.default.createElement(
    ...
    ), i < facets.length - 1 && /* @__PURE__ */ import_react79.default.createElement(FilterDivider, { className: customCssClasses.divider }));
  }));
}

// src/components/NumericalFacets.tsx
var import_react80 = __toESM(require("react"));
var DEFAULT_RANGE_INPUT_PREFIX = /* @__PURE__ */ import_react80.default.createElement(import_react80.default.Fragment, null, "$");
function NumericalFacets(_a) {
  ...
  return /* @__PURE__ */ import_react80.default.createElement(FacetsProvider, { searchOnChange, className: customCssClasses.numericalFacetsContainer }, (facets) => facets.filter((f) => isNumericalFacet(f) && (includedFieldIds.length === 0 || includedFieldIds.includes(f.fieldId))).map((f, i) => {
...
var DEFAULT_RANGE_INPUT_PREFIX2 = /* @__PURE__ */ import_react82.default.createElement(import_react82.default.Fragment, null, "$");
...
function HierarchicalFacetContent({
  ...
  const options = facet.options || [];
  const transformedOptions = transformOptions ? transformOptions(options) || [] : options;
  return /* @__PURE__ */ import_react83.default.createElement(FilterGroupProvider, { fieldId, defaultExpanded: !collapsible || defaultExpanded }, /* @__PURE__ */ import_react83.default.createElement(
    FacetTitle,
    {
  ...
  ), /* @__PURE__ */ import_react83.default.createElement(CollapsibleSection, null, /* @__PURE__ */ import_react83.default.createElement(
    HierarchicalFacetDisplay,
    {
...
function Facets(props) {
  ...
  return /* @__PURE__ */ import_react84.default.createElement("div", null, /* @__PURE__ */ import_react84.default.createElement(FacetsProvider, { searchOnChange, className: customCssClasses.facetsContainer }, (facets) => {
    ...
    return fieldIds.filter((fieldId) => !excludedFieldIds.includes(fieldId) && fieldIdToFacet.get(fieldId).options.length > 0 && (!onlyRenderChildren || fieldIdToCustomFacetProps.has(fieldId))).map((fieldId, i) => {
      ...
      return /* @__PURE__ */ import_react84.default.createElement(import_react84.Fragment, { key: facet.fieldId }, /* @__PURE__ */ import_react84.default.createElement(
        Facet,
        {
          facet,
      ...
      ), i < facets.length - 1 && /* @__PURE__ */ import_react84.default.createElement(FilterDivider, { className: customCssClasses == null ? void 0 : customCssClasses.divider }));
    });
  }));
}
...
function Facet({
  ...
  switch (facetType) {
    case "NUMERICAL" /* NUMERICAL */:
      return /* @__PURE__ */ import_react84.default.createElement(NumericalFacetContent, __spreadValues({ facet }, facetProps));
    case "HIERARCHICAL" /* HIERARCHICAL */:
      return /* @__PURE__ */ import_react84.default.createElement(HierarchicalFacetContent, __spreadValues({ facet }, facetProps));
    case "STANDARD" /* STANDARD */:
    default:
      return /* @__PURE__ */ import_react84.default.createElement(StandardFacetContent, __spreadValues({ facet }, facetProps));
  }
}
...
function MapboxMap({
  ...
  const mapContainer = (0, import_react87.useRef)(null);
  const map = (0, import_react87.useRef)(null);
  const markers = (0, import_react87.useRef)([]);
    ...
    if (mapbox && (locationResults == null ? void 0 : locationResults.length) > 0) {
      ...
      locationResults.forEach((result, i) => {
        ...
        if (markerLocation) {
          ...
          const markerOptions = {};
          if (PinComponent2) {
            import_react_dom.default.render(/* @__PURE__ */ import_react87.default.createElement(
              PinComponent2,
              {
                index: i,
                mapbox,
  ...
  return /* @__PURE__ */ import_react87.default.createElement("div", { ref: mapContainer, className: "h-full w-full" });
}
...
function AnalyticsProvider(props) {
  ...
  return /* @__PURE__ */ import_react88.default.createElement(AnalyticsContext.Provider, { value: analyticsReporter }, children);
}
