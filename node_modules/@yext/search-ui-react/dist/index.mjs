...
import React13, { Fragment, isValidElement as isValidElement3, useCallback as useCallback5, useEffect as useEffect5, useMemo as useMemo3 } from "react";
...
function Dropdown(props) {
  ...
  return /* @__PURE__ */ React7.createElement("div", { ref: containerRef, className: isActive ? activeClassName : className, onKeyDown: handleKeyDown }, /* @__PURE__ */ React7.createElement(DropdownContext.Provider, { value: dropdownContext }, /* @__PURE__ */ React7.createElement(InputContext.Provider, { value: inputContext }, /* @__PURE__ */ React7.createElement(FocusContext.Provider, { value: focusContext }, childrenWithDropdownItemsTransformed))), /* @__PURE__ */ React7.createElement(
    ScreenReader,
    {
...
function getTransformedChildrenAndItemData(children) {
  ...
  const childrenWithDropdownItemsTransformed = recursivelyMapChildren(children, (child) => {
    ...
    return createElement(DropdownItemWithIndex, __spreadProps(__spreadValues({}, props), { index: items.length - 1 }));
  });
  return [childrenWithDropdownItemsTransformed, items];
}

// src/components/Dropdown/DropdownInput.tsx
import React8, { useCallback as useCallback4, useRef as useRef6, useState as useState5 } from "react";
...
function SearchButton({ handleClick, className }) {
  return /* @__PURE__ */ React10.createElement(
    ...
    /* @__PURE__ */ React10.createElement(MagnifyingGlassIcon, null)
  );
}
...
function renderHighlightedValue(highlightedValueOrString, customCssClasses) {
  ...
  if (!matchedSubstrings || matchedSubstrings.length === 0) {
    return /* @__PURE__ */ React11.createElement("span", null, value);
  }
  ...
  for (const { offset, length } of substrings) {
    if (offset > curr) {
      highlightedJSX.push(
        /* @__PURE__ */ React11.createElement("span", { key: curr, className: cssClasses.nonHighlighted }, value.substring(curr, offset))
      );
    }
    highlightedJSX.push(
      /* @__PURE__ */ React11.createElement("span", { key: offset, className: cssClasses.highlighted }, value.substring(offset, offset + length))
    );
    curr = offset + length;
  }
  if (curr < value.length) {
    highlightedJSX.push(
      /* @__PURE__ */ React11.createElement("span", { key: curr, className: cssClasses.nonHighlighted }, value.substring(curr))
    );
  }
  return /* @__PURE__ */ React11.createElement(React11.Fragment, null, highlightedJSX);
}
...
function renderAutocompleteResult(result, cssClasses = {}, Icon, ariaLabel) {
  return /* @__PURE__ */ React12.createElement(React12.Fragment, null, Icon && /* @__PURE__ */ React12.createElement("div", { className: cssClasses.icon }, /* @__PURE__ */ React12.createElement(Icon, null)), /* @__PURE__ */ React12.createElement("div", { "aria-label": ariaLabel || "", className: cssClasses.option }, renderHighlightedValue(result, cssClasses)));
}
...
function SearchBar({
  ...
  function renderRecentSearches() {
    ...
    return filteredRecentSearches == null ? void 0 : filteredRecentSearches.map((result, i) => /* @__PURE__ */ React13.createElement(
      DropdownItem,
      {
  ...
  function renderQuerySuggestions() {
    return autocompleteResponse == null ? void 0 : autocompleteResponse.results.map((result, i) => {
      var _a2;
      return /* @__PURE__ */ React13.createElement(Fragment, { key: i }, /* @__PURE__ */ React13.createElement(
        DropdownItem,
        {
      ...
      ), showVerticalLinks && !isVertical && ((_a2 = result.verticalKeys) == null ? void 0 : _a2.map((verticalKey2, j) => /* @__PURE__ */ React13.createElement(
        DropdownItem,
        {
          key: j,
          className: "flex items-stretch py-1.5 px-3.5 cursor-pointer hover:bg-gray-100",
  ...
  function renderClearButton() {
    ...
    ), /* @__PURE__ */ React13.createElement(VerticalDividerIcon, { className: cssClasses.verticalDivider }));
  }
  ...
  return /* @__PURE__ */ React13.createElement("div", { className: cssClasses.searchBarContainer }, /* @__PURE__ */ React13.createElement(
    Dropdown,
    {
    ...
    /* @__PURE__ */ React13.createElement("div", { className: "inline-flex items-center justify-between w-full" }, renderInput(), query && renderClearButton(), /* @__PURE__ */ React13.createElement(
    ...
    hasItems && /* @__PURE__ */ React13.createElement(StyledDropdownMenu, { cssClasses }, renderRecentSearches(), renderQuerySuggestions(), showEntityPreviewsDivider && /* @__PURE__ */ React13.createElement("div", { className: cssClasses.entityPreviewsDivider }), entityPreviews)
  ));
}
function StyledDropdownMenu({ cssClasses, children }) {
  return /* @__PURE__ */ React13.createElement(DropdownMenu, null, /* @__PURE__ */ React13.createElement("div", { className: cssClasses.inputDivider }), /* @__PURE__ */ React13.createElement("div", { className: "bg-white py-4" }, children));
}
...
function DropdownSearchButton({ handleSubmit, cssClasses }) {
  ...
  return /* @__PURE__ */ React13.createElement("div", { className: cssClasses.searchButtonContainer }, /* @__PURE__ */ React13.createElement(
    SearchButton,
    {
...
import { useSearchState as useSearchState4, useSearchActions as useSearchActions3 } from "@yext/search-headless-react";
...
import {
  DirectAnswerType,
  useSearchState as useSearchState3
} from "@yext/search-headless-react";
...
function useCardAnalytics() {
  const analytics = useAnalytics();
  const verticalKey = useSearchState3((state) => state.vertical.verticalKey);
  const queryId = useSearchState3((state) => state.query.queryId);
  const reportCtaEvent = useCallback6((result, eventType) => {
  ...
  const reportFeedbackEvent = useCallback6((result, feedbackType) => {
    if (!queryId) {
  ...
  const reportAnalyticsEvent = useCallback6((cardResult, analyticsEventType) => {
    if (!analytics) {
      return;
    }
...
function useCardFeedbackCallback(result) {
  const reportAnalyticsEvent = useCardAnalytics();
  return useCallback8((analyticsType) => {
    reportAnalyticsEvent(result, analyticsType);
...
function SpellCheck({
  ...
  var _a, _b, _c;
  const verticalKey = (_a = useSearchState4((state) => state.vertical.verticalKey)) != null ? _a : "";
  const cssClasses = useComposedCssClasses(builtInCssClasses3, customCssClasses);
  const correctedQuery = (_b = useSearchState4((state) => state.spellCheck.correctedQuery)) != null ? _b : "";
  const isLoading = useSearchState4((state) => state.searchStatus.isLoading);
  ...
  const handleClickSuggestion = useCallback9(() => {
  ...
  return /* @__PURE__ */ React14.createElement("div", { className: containerClassNames }, /* @__PURE__ */ React14.createElement("span", { className: cssClasses.helpText }, "Did you mean "), /* @__PURE__ */ React14.createElement("button", { className: cssClasses.link, onClick: handleClickSuggestion }, correctedQuery));
}
...
function ThumbsFeedback(props) {
  ...
  const query = useSearchState5((state) => state.query.mostRecentSearch);
  const [isFeedbackProvided, setIsFeedbackProvided] = useState6(false);
  const handleClickThumbsUp = useCallback10(() => {
    onClick("THUMBS_UP");
    setIsFeedbackProvided(true);
  }, [onClick]);
  const handleClickThumbsDown = useCallback10(() => {
    onClick("THUMBS_DOWN");
    setIsFeedbackProvided(true);
  }, [onClick]);
  useLayoutEffect2(() => {
  ...
  return /* @__PURE__ */ React16.createElement("div", { className: cssClasses.thumbsFeedbackContainer }, isFeedbackProvided ? feedbackTextOnSubmission : /* @__PURE__ */ React16.createElement(React16.Fragment, null, feedbackText, /* @__PURE__ */ React16.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React16.createElement(ThumbIcon, null)
...
function FieldValueDirectAnswer2({
  ...
  return /* @__PURE__ */ React17.createElement("div", { className: cssClasses.answerContainer }, title && /* @__PURE__ */ React17.createElement("div", { className: cssClasses.header }, title), /* @__PURE__ */ React17.createElement("div", { className: cssClasses.content }, /* @__PURE__ */ React17.createElement("div", { className: cssClasses.body }, resultContent), link && /* @__PURE__ */ React17.createElement("div", { className: "mt-4" }, /* @__PURE__ */ React17.createElement("a", { href: link, className: "text-primary", onClick: viewDetailsClickHandler }, "View Details"))));
}
...
function getResultContent(result, UnknownFieldTypeDisplay = DefaultUnknownFieldTypeDisplay) {
  switch (result.fieldType) {
    ...
    case BuiltInFieldType.Hours:
      return /* @__PURE__ */ React17.createElement("div", null, JSON.stringify(result.value));
    case "unknown":
      return /* @__PURE__ */ React17.createElement(UnknownFieldTypeDisplay, { result });
    default:
      return Array.isArray(result.value) ? getListJsxElement(result.value, (val) => getTextJsxElement(val)) : getTextJsxElement(result.value);
  }
}
function getListJsxElement(list, getItemJsxElement) {
  return /* @__PURE__ */ React17.createElement("ul", { className: "list-disc list-inside" }, list.map((el, i) => /* @__PURE__ */ React17.createElement("li", { key: i }, getItemJsxElement(el))));
}
function getTextJsxElement(text) {
  return /* @__PURE__ */ React17.createElement("p", { className: "whitespace-pre-wrap" }, text);
}
function getAnchorTagJsxElement(href, displayText) {
  return /* @__PURE__ */ React17.createElement("a", { href, className: "text-primary" }, displayText != null ? displayText : href);
}
function getAddressJsxElement(address) {
  if (address.extraDescription) {
    return /* @__PURE__ */ React17.createElement("div", null, address.extraDescription);
  }
  ...
  return /* @__PURE__ */ React17.createElement("div", null, address.line1 && /* @__PURE__ */ React17.createElement("p", null, address.line1), address.line2 && /* @__PURE__ */ React17.createElement("p", null, address.line2), address.line3 && /* @__PURE__ */ React17.createElement("p", null, address.line3), formattedCityRegionPostalCode && /* @__PURE__ */ React17.createElement("p", null, formattedCityRegionPostalCode), /* @__PURE__ */ React17.createElement("p", null, address.countryCode));
}
...
function FeaturedSnippetDirectAnswer({
  ...
  if (result.fieldType === "html") {
    snippet = /* @__PURE__ */ React18.createElement("div", { dangerouslySetInnerHTML: snippetValue });
  } else {
  ...
  return /* @__PURE__ */ React18.createElement("div", { className: cssClasses.answerContainer }, answer && /* @__PURE__ */ React18.createElement("div", { className: cssClasses.header }, answer), /* @__PURE__ */ React18.createElement("div", { className: cssClasses.content }, /* @__PURE__ */ React18.createElement("div", { className: cssClasses.body }, snippet), link && name && /* @__PURE__ */ React18.createElement("div", { className: "pt-4 text-neutral" }, snippetLinkMessage, /* @__PURE__ */ React18.createElement(
    "a",
    {
...
function DirectAnswer({
  ...
  return /* @__PURE__ */ React19.createElement("div", { className: containerCssClasses }, directAnswerResult.type === DirectAnswerType2.FieldValue ? /* @__PURE__ */ React19.createElement(
...
import React20, { useCallback as useCallback11, useEffect as useEffect6, useMemo as useMemo6, useState as useState7 } from "react";
...
function FilterSearch({
  ...
  function renderDropdownItems() {
    return sections.map((section, sectionIndex) => {
      return /* @__PURE__ */ React20.createElement("div", { className: "pb-2", key: sectionIndex }, section.label && /* @__PURE__ */ React20.createElement("div", { className: cssClasses.sectionLabel }, section.label), /* @__PURE__ */ React20.createElement("div", { className: cssClasses.optionsContainer }, section.results.map((result, index) => /* @__PURE__ */ React20.createElement(
        DropdownItem,
        {
          key: index,
  ...
  return /* @__PURE__ */ React20.createElement("div", { className: cssClasses.filterSearchContainer }, label && /* @__PURE__ */ React20.createElement("h1", { className: cssClasses.label }, label), /* @__PURE__ */ React20.createElement(
    Dropdown,
    {
    ...
    /* @__PURE__ */ React20.createElement(DropdownMenu, null, hasResults && /* @__PURE__ */ React20.createElement("div", { className: "absolute z-10 w-full shadow-lg rounded-md border border-gray-300 bg-white pt-3 pb-1 mt-1" }, renderDropdownItems()))
  ));
}
...
function LoadingIndicator() {
  return /* @__PURE__ */ React21.createElement("div", { className: "animate-[rotate_1.4s_linear_infinite]" }, /* @__PURE__ */ React21.createElement("svg", { className: "[stroke-dasharray:208] origin-[50%_50%] animate-[dash_1.4s_ease-in-out_infinite]", viewBox: "0 0 72 72" }, /* @__PURE__ */ React21.createElement("circle", { className: "", cx: "36", cy: "36", r: "33", stroke: "black", strokeWidth: "3", fill: "none" })));
}
...
function LocationBias({
  ...
  return /* @__PURE__ */ React22.createElement("div", { className: cssClasses.locationBiasContainer }, /* @__PURE__ */ React22.createElement("span", { className: cssClasses.location }, locationBias.displayName), /* @__PURE__ */ React22.createElement("span", { className: cssClasses.source }, attributionMessage, /* @__PURE__ */ React22.createElement("span", { className: "invisible lg:visible" }, " - ")), /* @__PURE__ */ React22.createElement("div", { className: "flex flex-row items-center" }, /* @__PURE__ */ React22.createElement(
    "button",
    {
...
function Geolocation({
  ...
  return /* @__PURE__ */ React24.createElement("div", { className: cssClasses.geolocationContainer }, /* @__PURE__ */ React24.createElement("button", { className: cssClasses.button, onClick: handleGeolocationClick }, label), /* @__PURE__ */ React24.createElement("div", { className: cssClasses.iconContainer }, isFetchingUserLocation ? /* @__PURE__ */ React24.createElement(LoadingIndicator, null) : /* @__PURE__ */ React24.createElement(GeolocationIcon, null)));
}
...
function AppliedFiltersDisplay(props) {
  ...
  return /* @__PURE__ */ React25.createElement("div", { className: cssClasses.appliedFiltersContainer, "aria-label": "Applied filters to current search" }, dedupedNlpFilterDisplayNames.map((displayName, i) => renderNlpFilter(displayName, i, cssClasses)), dedupedRemovableFilters.map((f, i) => {
    return renderRemovableFilter(f.displayName, () => handleRemoveDedupedFilter(f), i, cssClasses);
  }), removableFilters.length > 0 && /* @__PURE__ */ React25.createElement("button", { onClick: handleClickClearAllButton, className: cssClasses.clearAllButton }, "Clear All"));
}
...
function renderRemovableFilter(displayName, handleRemove, index, cssClasses) {
  return /* @__PURE__ */ React25.createElement("div", { className: cssClasses.removableFilter, key: `${displayName}-${index}` }, /* @__PURE__ */ React25.createElement("div", { className: cssClasses.filterLabel }, displayName), /* @__PURE__ */ React25.createElement(
    "button",
    {
...
function renderNlpFilter(displayName, index, cssClasses) {
  return /* @__PURE__ */ React25.createElement("div", { className: cssClasses.nlpFilter, key: `${displayName}-${index}` }, /* @__PURE__ */ React25.createElement("span", { className: cssClasses.filterLabel }, displayName));
}

// src/components/Filters/HierarchicalFacetDisplay.tsx
import React26, { useCallback as useCallback14, useState as useState10 } from "react";
...
function HierarchicalFacetDisplay({
  ...
  function renderAvailableOptions(nodes) {
    ...
    return nodesToRender.map(
      (n) => /* @__PURE__ */ React26.createElement(
        AvailableOption,
        {
  ...
  function renderCategory(selectedNode, fieldId) {
    ...
    if (selectedNode.hasSelectedChild) {
      return /* @__PURE__ */ React26.createElement(ParentCategory, __spreadValues({ className: cssClasses.parentCategory }, sharedProps));
    } else {
      return /* @__PURE__ */ React26.createElement(CurrentCategory, __spreadValues({ className: cssClasses.currentCategory }, sharedProps));
    }
  }
  return /* @__PURE__ */ React26.createElement("div", { className: cssClasses.treeContainer }, renderTree());
}
function AllCategories({ facet, inactiveClassName, activeClassName, resetShowMore }) {
  ...
  return /* @__PURE__ */ React26.createElement("div", { className: activeClassName }, "All Categories");
}
...
function ParentCategory({ fieldId, selectedNode, className, resetShowMore }) {
  ...
  return /* @__PURE__ */ React26.createElement("button", { className, onClick: handleClickParentCategory }, selectedNode.lastDisplayNameToken + " /");
}
...
function ShowMoreButton({ className, isShowingMore, toggleShowMore }) {
  return /* @__PURE__ */ React26.createElement("button", { className, onClick: toggleShowMore }, isShowingMore ? "Show less" : "Show more");
}
...
function VerticalResultsDisplay(props) {
  ...
  return /* @__PURE__ */ React28.createElement("div", { className: resultsClassNames }, results == null ? void 0 : results.map((result) => renderResult(CardComponent, result)));
}
function renderResult(CardComponent, result) {
  return /* @__PURE__ */ React28.createElement(CardComponent, { result, key: result.id || result.index });
}
...
function StandardCardDisplay(props) {
  ...
  function renderTitle(title2, link2) {
    ...
    return link2 ? /* @__PURE__ */ React29.createElement("a", { href: link2, className: "text-lg font-medium text-primary hover:underline focus:underline", onClick: clickHandlers.handleTitleClick }, titleJsx) : /* @__PURE__ */ React29.createElement("div", { className: cssClasses.title }, titleJsx);
  }
  function renderCTAs(cta12, cta22) {
    if (cta12 || cta22) {
      return /* @__PURE__ */ React29.createElement("div", { className: "flex flex-col justify-end ml-4" }, cta12 && /* @__PURE__ */ React29.createElement("button", { className: cssClasses.cta1, onClick: clickHandlers.handleCtaClick }, cta12.label), cta22 && /* @__PURE__ */ React29.createElement("button", { className: cssClasses.cta2, onClick: clickHandlers.handleCtaClick }, cta22.label));
    }
    return null;
  }
  function renderDescription(text) {
    if (text) {
      return /* @__PURE__ */ React29.createElement("div", { className: "w-full" }, renderHighlightedValue(text, { highlighted: "font-semibold", nonHighlighted: "font-normal" }));
    }
    return null;
  }
  ...
  return /* @__PURE__ */ React29.createElement("div", { className: cssClasses.container }, /* @__PURE__ */ React29.createElement("div", { className: cssClasses.header }, renderTitle(title, link)), ((_a = description != null ? description : cta1) != null ? _a : cta2) && /* @__PURE__ */ React29.createElement("div", { className: cssClasses.body }, renderDescription(description), renderCTAs(cta1, cta2)), renderFeedbackIcons());
}
...
function StandardSection(props) {
  ...
  return /* @__PURE__ */ React31.createElement("section", { className: cssClasses.section }, header, /* @__PURE__ */ React31.createElement(
...
function SectionHeader(props) {
  ...
  return /* @__PURE__ */ React33.createElement("div", { className: cssClasses.sectionHeaderContainer }, /* @__PURE__ */ React33.createElement("div", { className: cssClasses.sectionHeaderIconContainer }, /* @__PURE__ */ React33.createElement(CollectionIcon, null)), /* @__PURE__ */ React33.createElement("h2", { className: cssClasses.sectionHeaderLabel }, label), appliedQueryFilters && /* @__PURE__ */ React33.createElement(AppliedFiltersDisplay, { nlpFilterDisplayNames, cssClasses }), viewAllButton && /* @__PURE__ */ React33.createElement("div", { className: cssClasses.viewMoreContainer }, /* @__PURE__ */ React33.createElement("a", { className: cssClasses.viewMoreLink, href }, /* @__PURE__ */ React33.createElement("button", { onClick: handleClickViewAllButton }, "View all"))));
}
...
function UniversalResults({
  ...
  return /* @__PURE__ */ React34.createElement("div", { className: resultsClassNames }, renderVerticalSections({ resultsFromAllVerticals, showAppliedFilters, verticalConfigMap, cssClasses }));
}
function renderVerticalSections(props) {
  const { resultsFromAllVerticals, verticalConfigMap, cssClasses } = props;
  return /* @__PURE__ */ React34.createElement(React34.Fragment, null, resultsFromAllVerticals.filter((verticalResults) => verticalResults.results).map((verticalResults) => {
    var _a;
    ...
    return /* @__PURE__ */ React34.createElement(
      SectionComponent,
      {
        results,
        verticalKey,
        header: /* @__PURE__ */ React34.createElement(SectionHeader, __spreadValues({}, {
          label,
          appliedQueryFilters,
          verticalKey,
...
function VerticalResults(props) {
  ...
  return /* @__PURE__ */ React35.createElement(VerticalResultsDisplay, __spreadValues({ results, isLoading }, otherProps));
}
...
function ChevronIcon({ className }) {
  return /* @__PURE__ */ React36.createElement(
    ...
    /* @__PURE__ */ React36.createElement("path", { d: "M1.33341 6.5L6.00008 1.83333L10.6667 6.5", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" })
  );
}
...
// src/components/Pagination.tsx
import React37, { useCallback as useCallback16 } from "react";
...
function Pagination(props) {
  ...
  return /* @__PURE__ */ React37.createElement("div", { className: paginationContainerClassNames }, /* @__PURE__ */ React37.createElement("nav", { className: "inline-flex shadow-sm -space-x-px", "aria-label": "Pagination" }, /* @__PURE__ */ React37.createElement(
    PaginationButton,
    {
    ...
    /* @__PURE__ */ React37.createElement(ChevronIcon, { className: cssClasses.icon + " transform -rotate-90" })
...
function StarIcon({ className }) {
  return /* @__PURE__ */ React38.createElement(
    ...
    /* @__PURE__ */ React38.createElement("path", { d: "M8.991 0C4.023 0 0 4.032 0 9s4.023 9 8.991 9C13.968 18 18 13.968 18 9s-4.032-9-9.009-9zm3.816 14.4L9 12.105 5.193 14.4l1.008-4.329-3.357-2.907 4.428-.378L9 2.7l1.728 4.077 4.428.378-3.357 2.907z" })
  );
}
...
function AlternativeVerticals({
  ...
  return /* @__PURE__ */ React39.createElement("div", { className: containerClassNames }, renderNoResultsInfo(), verticalSuggestions && /* @__PURE__ */ React39.createElement("div", { className: "pt-4 text-neutral-dark" }, /* @__PURE__ */ React39.createElement("div", { className: cssClasses.categoriesText }, /* @__PURE__ */ React39.createElement("span", null, processTranslation({
  ...
  })), /* @__PURE__ */ React39.createElement("strong", null, query)), /* @__PURE__ */ React39.createElement("ul", { className: "pt-4" }, verticalSuggestions.map(renderSuggestion))));
  function renderNoResultsInfo() {
    return /* @__PURE__ */ React39.createElement("div", { className: cssClasses.noResultsText }, /* @__PURE__ */ React39.createElement("span", null, "No results found in ", currentVerticalLabel, "."), isShowingAllResults && /* @__PURE__ */ React39.createElement("span", null, " Showing all ", currentVerticalLabel, " instead."));
  }
  function renderSuggestion(suggestion) {
    ...
    return /* @__PURE__ */ React39.createElement("li", { key: suggestion.verticalKey, className: cssClasses.suggestion }, /* @__PURE__ */ React39.createElement("div", { className: cssClasses.verticalIcon }, /* @__PURE__ */ React39.createElement(StarIcon, null)), /* @__PURE__ */ React39.createElement("span", { className: "font-bold" }, suggestion.label, " - ", resultsCountText));
  }
}
...
function ResultsCount({ customCssClasses }) {
  ...
  return /* @__PURE__ */ React40.createElement("div", { className: resultsCountClassnames }, resultsCountText);
}
...
import React41, { useCallback as useCallback17, useEffect as useEffect7, useMemo as useMemo11 } from "react";
...
function CheckboxOption(props) {
  ...
  return /* @__PURE__ */ React41.createElement("div", { className: cssClasses.container }, /* @__PURE__ */ React41.createElement("div", { className: cssClasses.optionContainer }, /* @__PURE__ */ React41.createElement(
    "input",
    {
      type: "checkbox",
      id: optionId,
  ...
  ), /* @__PURE__ */ React41.createElement("label", { className: labelClasses, htmlFor: optionId }, labelText)), isOptionsDisabled && /* @__PURE__ */ React41.createElement("div", { className: cssClasses.tooltipContainer }, /* @__PURE__ */ React41.createElement("div", { className: cssClasses.tooltip }, "Clear the range to select options.")));
}
...
function CollapsibleLabel({ label, customCssClasses }) {
  ...
  return /* @__PURE__ */ React42.createElement("button", __spreadValues({ className: "w-full flex justify-between items-center mb-4" }, getToggleProps()), /* @__PURE__ */ React42.createElement("div", { className: cssClasses.label }, label), /* @__PURE__ */ React42.createElement(ChevronIcon, { className: iconClassName }));
}
...
function CollapsibleSection(props) {
  ...
  return /* @__PURE__ */ React43.createElement("div", __spreadValues({ className }, getCollapseProps()), children);
}
...
function FacetsProvider({
  ...
  return /* @__PURE__ */ React44.createElement("div", { className }, /* @__PURE__ */ React44.createElement(FiltersContext.Provider, { value: filtersContextInstance }, children == null ? void 0 : children(facets)));
}

// src/components/Filters/FilterGroupProvider.tsx
import React45, { useMemo as useMemo13, useState as useState11 } from "react";
...
function FilterGroupProvider(props) {
  ...
  return /* @__PURE__ */ React45.createElement(FilterGroupContext.Provider, { value: FilterGroupContextInstance }, children);
}

// src/components/Filters/SearchInput.tsx
import React46, { useCallback as useCallback18 } from "react";
...
import React47, { useMemo as useMemo14 } from "react";
function StaticFiltersProvider({
  ...
  return /* @__PURE__ */ React47.createElement("div", { className }, /* @__PURE__ */ React47.createElement(FiltersContext.Provider, { value: filtersContextInstance }, children));
}
...
import React49, { useCallback as useCallback19, useEffect as useEffect8, useMemo as useMemo15, useState as useState12 } from "react";
import classNames12 from "classnames";

// src/icons/InvalidIcon.tsx
import React48 from "react";
function InvalidIcon() {
  return /* @__PURE__ */ React48.createElement("svg", { width: "20", height: "18", viewBox: "0 0 20 18", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, /* @__PURE__ */ React48.createElement("path", { d: "M9.99955 7V9M9.99955 13H10.0095M3.07134 17H16.9277C18.4673 17 19.4296 15.3333 18.6598 14L11.7316 2C10.9618 0.666667 9.0373 0.666667 8.2675 2L1.33929 14C0.569492 15.3333 1.53174 17 3.07134 17Z", stroke: "#B91C1C", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }));
}
...
function RangeInput(props) {
  ...
  function renderInput(value, onChange, placeholder) {
    return /* @__PURE__ */ React49.createElement("div", { className: cssClasses.inputContainer }, inputPrefix && /* @__PURE__ */ React49.createElement("span", { className: inputPrefixClasses, "aria-hidden": "true" }, inputPrefix), /* @__PURE__ */ React49.createElement(
      "input",
      {
        type: "text",
        inputMode: "decimal",
  ...
  return /* @__PURE__ */ React49.createElement("div", { className: cssClasses.rangeInputContainer }, /* @__PURE__ */ React49.createElement("div", { className: cssClasses.inputRowContainer }, renderInput(minRangeInput, handleMinChange, "Min"), /* @__PURE__ */ React49.createElement("div", { className: "w-2.5 text-sm text-neutral" }, "-"), renderInput(maxRangeInput, handleMaxChange, "Max"), isDisabled && /* @__PURE__ */ React49.createElement("div", { className: cssClasses.tooltipContainer }, /* @__PURE__ */ React49.createElement("div", { className: cssClasses.tooltip }, "Unselect an option to enter in a range."))), !isValid && /* @__PURE__ */ React49.createElement("div", { className: cssClasses.invalidRowContainer }, /* @__PURE__ */ React49.createElement(InvalidIcon, null), /* @__PURE__ */ React49.createElement("div", { className: cssClasses.invalidMessage }, "Invalid range")), hasUserInput && /* @__PURE__ */ React49.createElement("div", { className: cssClasses.buttonsContainer }, /* @__PURE__ */ React49.createElement(
    "button",
    {
      className: cssClasses.clearButton,
    ...
    "Clear min and max"
  ), shouldRenderApplyButton && /* @__PURE__ */ React49.createElement(
    "button",
    {
...
import React51, { useMemo as useMemo17, useState as useState13 } from "react";

// src/components/FacetTiltle.tsx
import React50, { Fragment as Fragment2, useMemo as useMemo16 } from "react";
function FacetTitle({
  label,
  customCssClasses,
  collapsible = true
  ...
  return /* @__PURE__ */ React50.createElement(Fragment2, null, collapsible ? /* @__PURE__ */ React50.createElement(CollapsibleLabel, { label, customCssClasses: collapsibleLabelCssClasses }) : label && /* @__PURE__ */ React50.createElement("div", { className: twMerge(
    "mb-4",
...
function FilterGroup({
  ...
  return /* @__PURE__ */ React51.createElement(
    ...
    /* @__PURE__ */ React51.createElement(CollapsibleSection, { className: cssClasses.optionsContainer }, searchable && /* @__PURE__ */ React51.createElement(SearchInput, { className: cssClasses.searchInput }), /* @__PURE__ */ React51.createElement(
      CheckboxOptions,
      {
        filterOptions,
        showMoreLimit,
...
function CheckboxOptions({
  ...
  return /* @__PURE__ */ React51.createElement(React51.Fragment, null, displayedOptions, isLimited && /* eslint-disable-next-line react-perf/jsx-no-new-function-as-prop */
  /* @__PURE__ */ React51.createElement("button", { className: "text-primary py-1 text-sm", onClick: () => setShowAll(!showAll) }, showAll ? "Show Less" : "Show More"));
}
...
function StaticFilters(props) {
  ...
  return /* @__PURE__ */ React52.createElement(StaticFiltersProvider, { searchOnChange, className: containerClassName }, /* @__PURE__ */ React52.createElement(
    FilterGroup,
    __spreadValues({
...
import React54, { Fragment as Fragment3 } from "react";

// src/components/FilterDivider.tsx
import React53 from "react";
function FilterDivider({ className }) {
  return /* @__PURE__ */ React53.createElement("div", { className: twMerge("w-full h-px bg-gray-200 my-4", className) });
}
...
function StandardFacets(props) {
  ...
  return /* @__PURE__ */ React54.createElement(FacetsProvider, { searchOnChange, className: customCssClasses.standardFacetsContainer }, (facets) => facets.filter((f) => !excludedFieldIds.includes(f.fieldId) && isStringFacet(f)).map((f, i) => {
    return /* @__PURE__ */ React54.createElement(Fragment3, { key: f.fieldId }, /* @__PURE__ */ React54.createElement(
      FilterGroup,
      __spreadValues({
        fieldId: f.fieldId,
    ...
    ), i < facets.length - 1 && /* @__PURE__ */ React54.createElement(FilterDivider, { className: customCssClasses.divider }));
  }));
}

// src/components/HierarchicalFacets.tsx
import React55, { Fragment as Fragment4 } from "react";
function HierarchicalFacets({
  ...
  return /* @__PURE__ */ React55.createElement(FacetsProvider, { searchOnChange, className: customCssClasses.hierarchicalFacetsContainer }, (facets) => facets.filter((f) => f.options.length > 0 && includedFieldIds.includes(f.fieldId)).map((f, i) => {
    return /* @__PURE__ */ React55.createElement(Fragment4, { key: f.fieldId }, /* @__PURE__ */ React55.createElement(
      FilterGroupProvider,
      {
        fieldId: f.fieldId,
        defaultExpanded: !collapsible || defaultExpanded
      },
      collapsible ? /* @__PURE__ */ React55.createElement(CollapsibleLabel, { label: f.displayName }) : f.displayName && /* @__PURE__ */ React55.createElement("div", { className: "text-neutral-dark text-sm font-medium text-left mb-4" }, f.displayName),
      /* @__PURE__ */ React55.createElement(CollapsibleSection, null, /* @__PURE__ */ React55.createElement(
    ...
    ), i < facets.length - 1 && /* @__PURE__ */ React55.createElement(FilterDivider, { className: customCssClasses.divider }));
  }));
}

// src/components/NumericalFacets.tsx
import React56, { Fragment as Fragment5 } from "react";
var DEFAULT_RANGE_INPUT_PREFIX = /* @__PURE__ */ React56.createElement(React56.Fragment, null, "$");
function NumericalFacets(_a) {
  ...
  return /* @__PURE__ */ React56.createElement(FacetsProvider, { searchOnChange, className: customCssClasses.numericalFacetsContainer }, (facets) => facets.filter((f) => isNumericalFacet(f) && (includedFieldIds.length === 0 || includedFieldIds.includes(f.fieldId))).map((f, i) => {
    return /* @__PURE__ */ React56.createElement(Fragment5, { key: f.fieldId }, /* @__PURE__ */ React56.createElement(
      FilterGroup,
      __spreadValues({
        fieldId: f.fieldId,
...
import React60, { Fragment as Fragment6 } from "react";

// src/components/NumericalFacetContent.tsx
import React58 from "react";
var DEFAULT_RANGE_INPUT_PREFIX2 = /* @__PURE__ */ React58.createElement(React58.Fragment, null, "$");
...
function HierarchicalFacetContent({
  ...
  const options = facet.options || [];
  const transformedOptions = transformOptions ? transformOptions(options) || [] : options;
  return /* @__PURE__ */ React59.createElement(FilterGroupProvider, { fieldId, defaultExpanded: !collapsible || defaultExpanded }, /* @__PURE__ */ React59.createElement(
    FacetTitle,
    {
  ...
  ), /* @__PURE__ */ React59.createElement(CollapsibleSection, null, /* @__PURE__ */ React59.createElement(
    HierarchicalFacetDisplay,
    {
...
function Facets(props) {
  ...
  return /* @__PURE__ */ React60.createElement("div", null, /* @__PURE__ */ React60.createElement(FacetsProvider, { searchOnChange, className: customCssClasses.facetsContainer }, (facets) => {
    ...
    return fieldIds.filter((fieldId) => !excludedFieldIds.includes(fieldId) && fieldIdToFacet.get(fieldId).options.length > 0 && (!onlyRenderChildren || fieldIdToCustomFacetProps.has(fieldId))).map((fieldId, i) => {
      ...
      return /* @__PURE__ */ React60.createElement(Fragment6, { key: facet.fieldId }, /* @__PURE__ */ React60.createElement(
        Facet,
        {
          facet,
      ...
      ), i < facets.length - 1 && /* @__PURE__ */ React60.createElement(FilterDivider, { className: customCssClasses == null ? void 0 : customCssClasses.divider }));
    });
  }));
}
...
function Facet({
  ...
  switch (facetType) {
    case "NUMERICAL" /* NUMERICAL */:
      return /* @__PURE__ */ React60.createElement(NumericalFacetContent, __spreadValues({ facet }, facetProps));
    case "HIERARCHICAL" /* HIERARCHICAL */:
      return /* @__PURE__ */ React60.createElement(HierarchicalFacetContent, __spreadValues({ facet }, facetProps));
    case "STANDARD" /* STANDARD */:
    default:
      return /* @__PURE__ */ React60.createElement(StandardFacetContent, __spreadValues({ facet }, facetProps));
  }
}
...
import React62, { useRef as useRef8, useEffect as useEffect9 } from "react";
...
function MapboxMap({
    ...
    if (mapbox && (locationResults == null ? void 0 : locationResults.length) > 0) {
      ...
      locationResults.forEach((result, i) => {
        ...
        if (markerLocation) {
          ...
          const markerOptions = {};
          if (PinComponent2) {
            ReactDOM.render(/* @__PURE__ */ React62.createElement(
              PinComponent2,
              {
                index: i,
                mapbox,
  ...
  return /* @__PURE__ */ React62.createElement("div", { ref: mapContainer, className: "h-full w-full" });
}
...
function AnalyticsProvider(props) {
  ...
  return /* @__PURE__ */ React63.createElement(AnalyticsContext.Provider, { value: analyticsReporter }, children);
}
