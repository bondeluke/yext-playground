      ...
      return __generator(this, function (_f) {
        switch (_f.label) {
          case 0:
            ...
            if (!('token' in this.config)) return [3 /*break*/, 2];
            return [4 /*yield*/, this.httpService.get(this.universalSearchEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders), this.config.token)];
          case 1:
            _e = _f.sent();
            return [3 /*break*/, 4];
          case 2:
            return [4 /*yield*/, this.httpService.get(this.universalSearchEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders))];
          case 3:
            _e = _f.sent();
            _f.label = 4;
          case 4:
            ...
            return [2 /*return*/, (0, _createUniversalSearchResponse.createUniversalSearchResponse)(response)];
        }
      });
    });
  };
      ...
      return __generator(this, function (_f) {
        switch (_f.label) {
          case 0:
            ...
            if (!('token' in this.config)) return [3 /*break*/, 2];
            return [4 /*yield*/, this.httpService.get(this.verticalSearchEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders), this.config.token)];
          case 1:
            _e = _f.sent();
            return [3 /*break*/, 4];
          case 2:
            return [4 /*yield*/, this.httpService.get(this.verticalSearchEndpoint, queryParams, (0, _getClientSdk.getClientSdk)(request.additionalHttpHeaders))];
          case 3:
            _e = _f.sent();
            _f.label = 4;
          case 4:
            ...
            return [2 /*return*/, (0, _createVerticalSearchResponse.createVerticalSearchResponse)(response)];
        }
      });
    });
  };
...
(function (BuiltInFieldType) {
  ...
  BuiltInFieldType["RichText_v2"] = "rich_text_v2";
  BuiltInFieldType["Html"] = "html";
  BuiltInFieldType["Markdown"] = "markdown";
...
var ResultsFactory = /** @class */function () {
  ...
  ResultsFactory.create = function (results, source) {
    ...
    return (0, _map.default)(results).call(results, function (result, index) {
      ...
      switch (source) {
        ...
        case _Source.Source.DocumentVertical:
  ...
  ResultsFactory.fromDocumentVertical = function (result, index) {
    ...
    return {
      rawData: rawData,
      source: _Source.Source.DocumentVertical,
      name: rawData.name,
      description: rawData.description,
      link: rawData.website,
      id: rawData.id,
...
var supportedFieldTypes = [_BuiltInFieldType.BuiltInFieldType.MultiLineText, _BuiltInFieldType.BuiltInFieldType.RichText, _BuiltInFieldType.BuiltInFieldType.RichText_v2, _BuiltInFieldType.BuiltInFieldType.Markdown, _BuiltInFieldType.BuiltInFieldType.Html];
function createDirectAnswer(data) {
  ...
  if (isFieldValueDirectAnswer) {
    ...
    if (!(0, _includes.default)(supportedFieldTypes).call(supportedFieldTypes, fieldType)) {
